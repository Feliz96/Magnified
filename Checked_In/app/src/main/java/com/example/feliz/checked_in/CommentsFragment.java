...
public class CommentsFragment extends Fragment implements TaskProvider {
    ...
    private Event_Profile mActivity;
...
//        mActivity = (Event_Profile) getActivity();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etCommentbody = (EditText) rootView.findViewById(R.id.txtCommentBody);
    ...
    private void updateComments() {
        ...
        if (commentsList.size() != oldCommentsList.size()) {
            ...
            int[] to = new int[]{
                    R.id.txtAuthorName, R.id.txtCommentDate, R.id.txtCommentBody
            };
